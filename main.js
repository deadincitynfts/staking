...
function PopulateMenu(rates,staked, unstakeasset, user, balance) {
  ...
  console.log(balance);
  document.getElementById('stakepwr').innerHTML=user.stakePower + " RDA/H";
...
async function logout() {
  ...
  document.getElementById("dashtxt").style.display = "none";
  loggedIn = false;
  HideMessage();
}
async function login() {
  try {
    if (!loggedIn) {
      ...
      document.getElementById("dashtxt").style.display = "block";
